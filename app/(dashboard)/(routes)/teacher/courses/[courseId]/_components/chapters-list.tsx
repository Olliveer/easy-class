...
function ChaptersList({ items, onEdit, onReorder }: ChapterListProps) {
            ...
            {chapters.map((chapter, index) => (
              ...
              >
                {(provided) => (
                  <div
                    className={cn(
                      "flex items-center gap-x-2 bg-slate-200 border-slate-200 nborder text-slate-700 rounded-md mb-4 text-sm",
                      chapter.isPublished &&
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        chapter.isPublished &&
                          "border-r-sky-200 hopver:bg-sky-200"
                      )}
